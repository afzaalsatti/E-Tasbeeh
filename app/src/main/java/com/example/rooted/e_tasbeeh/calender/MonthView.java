...
import static com.example.rooted.e_tasbeeh.calender.MaterialHijriCalendarView.SHOW_DEFAULTS;
...
class MonthView extends ViewGroup implements View.OnClickListener {
    ...
    public void setShowOtherDates(@MaterialHijriCalendarView.ShowOtherDates int showFlags) {
