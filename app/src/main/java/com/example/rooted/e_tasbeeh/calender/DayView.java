...
import com.example.rooted.e_tasbeeh.calender.format.DayFormatter;

import java.util.List;

import static com.example.rooted.e_tasbeeh.calender.MaterialHijriCalendarView.showDecoratedDisabled;
import static com.example.rooted.e_tasbeeh.calender.MaterialHijriCalendarView.showOtherMonths;
import static com.example.rooted.e_tasbeeh.calender.MaterialHijriCalendarView.showOutOfRange;
...
class DayView extends android.support.v7.widget.AppCompatCheckedTextView {
    ...
    protected void setupSelection(@MaterialHijriCalendarView.ShowOtherDates int showOtherDates, boolean inRange, boolean inMonth) {
